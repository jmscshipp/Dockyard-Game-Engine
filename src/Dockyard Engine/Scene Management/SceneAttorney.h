...
public:
	...
	private:
		...
		static void Register(Inputable* inp, KEY k, InputableAttorney::EVENT_TYPE e, InputableAttorney::InputColRef& ref) { SceneManager::GetCurrentScene()->keyboardEventMgr->Register(inp, k, e, ref); };
		...
		static void Deregister(KEY k, InputableAttorney::EVENT_TYPE e, InputableAttorney::InputColRef ref) { SceneManager::GetCurrentScene()->keyboardEventMgr->Deregister(k, e, ref); };
