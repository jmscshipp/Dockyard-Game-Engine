...
ShaderCartoon::ShaderCartoon()
	: Shader(L"../Assets/Shaders/Cartoon.hlsl")
{
	...
	// Color buffer
	bd.Usage = D3D11_USAGE_DEFAULT;
	bd.ByteWidth = sizeof(DataWorldMatColors);
	bd.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
	bd.CPUAccessFlags = 0;
	bd.MiscFlags = 0;
	bd.StructureByteStride = 0;
...
void ShaderCartoon::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderCartoon::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderCartoon::SetPointLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderCartoon::SetSpotLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderCartoon::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderCartoon::SendWorldMatColors(const Matrix& world, const Vect& color0, const Vect& color1, const Vect& color2, const Vect& amb, const Vect& dif, const Vect& sp)
{
	DataWorldMatColors wm;
	wm.World = world;
...
void ShaderCartoon::SendFogValues(const float& fogStart, const float& fogRange, const Vect& fogColor)
{
	FogValues fv;
...
void ShaderCartoon::SetToContext(ID3D11DeviceContext* devcon)
{
...
void ShaderCartoon::SetTextureResourceAndSampler(Texture* tex)
{
