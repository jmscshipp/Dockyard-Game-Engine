#ifndef _ShaderCartoon
#define _ShaderCartoon
...
public:
	ShaderCartoon();
	ShaderCartoon(const ShaderCartoon&) = delete;				 // Copy constructor
	ShaderCartoon(ShaderCartoon&&) = default;                  // Move constructor
	ShaderCartoon& operator=(const ShaderCartoon&) = default;  // Copy assignment operator
	ShaderCartoon& operator=(ShaderCartoon&&) = default;       // Move assignment operator
	~ShaderCartoon();		  							             // Destructor
	...
	void SendWorldMatColors(const Matrix& world, const Vect& color0, const Vect& color1, const Vect& color2, const Vect& amb = Vect(.5f, .5f, .5f), const Vect& dif = Vect(.5f, .5f, .5f), const Vect& sp = Vect(.5f, .5f, .5f));
